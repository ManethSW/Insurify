...
class RegisterTestScreen extends StatefulWidget {
  ...
  @override
  RegisterTestScreenState createState() => RegisterTestScreenState();
}

class RegisterTestScreenState extends State<RegisterTestScreen> {
  ...
  Widget buildLabelBackground(double labelbackgroundwidth) {
    return Positioned(
      top: -0.5,
      left: 7.5,
      child: Container(
    ...
    return Flexible(
      child: Stack(
        ...
        children: <Widget>[
          ...
          buildLabelBackground(labelbackgroundwidth),
          buildLabel(label),
        ],
      ),
    );
